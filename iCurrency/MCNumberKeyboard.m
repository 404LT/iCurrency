...
@property (weak, nonatomic) IBOutlet UIButton *pointButton; //点
@property (weak, nonatomic) IBOutlet UIButton *clearButton;//清空
@property (weak, nonatomic) IBOutlet UIButton *plusButton;
@property (weak, nonatomic) IBOutlet UIButton *minusButton;
@property (weak, nonatomic) IBOutlet UIButton *multiplyButton;//乘
@property (weak, nonatomic) IBOutlet UIButton *divideButton;//除
